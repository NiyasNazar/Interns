...
public class CenResults_page extends AppCompatActivity {
...
progressDialog=new ProgressDialog(CenResults_page.this);
...
progressDialog.setCancelable(false);
    ...
    private void Add_resultoserver(String userid, String examid, String courseid, String totalmarkfrom, String rightanswer, String wronganswers) {
        ...
        Call<Response_add_result>call=apiservice.admockres(userid,examid,courseid,totalmarkfrom,rightanswer,wronganswers,"2");
