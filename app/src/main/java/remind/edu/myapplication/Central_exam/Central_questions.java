...
public class Central_questions extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView=(ImageView)findViewById(R.id.ims);
        id=getIntent().getStringExtra("id");
        time= Integer.parseInt(getIntent().getStringExtra("time"));
        calculatedtime = time * 60000;
        Log.i("idxx",id);
        progressDialog=new ProgressDialog(Central_questions.this);
    ...
    private void finishac(String a, String b, String c, String d) {
        Intent is=new Intent(getApplicationContext(),CenResults_page.class);
